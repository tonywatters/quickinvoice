        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
            ...
            <div className="space-y-8">
              ...
              {/* Line Items - MOBILE FIXED VERSION */}
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Items</h3>
                <div className="space-y-3">
                  {formData.items.map((item, index) => (
                    <div key={index} className="flex flex-col md:flex-row gap-3 items-start border-b pb-3 md:border-0 md:pb-0">
                      <input
                        type="text"
                        placeholder="Description *"
                        value={item.description}
                        onChange={(e) => handleItemChange(index, 'description', e.target.value)}
                        className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent w-full"
                      />
                      <div className="flex gap-3 w-full md:w-auto">
                        <input
                          ...
                          className="flex-1 md:w-20 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                        />
                        <input
                          type="number"
                          placeholder="Rate"
                          ...
                          className="flex-1 md:w-32 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                        />
                        <div className="flex-1 md:w-32 px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 font-medium text-center md:text-left">
                      ...
                      {formData.items.length > 1 && (
                        <button
                          ...
                          className="p-3 text-red-600 hover:bg-red-50 rounded-lg transition-colors self-center md:self-auto"
                        >
                          <Trash2 size={20} />
                        </button>
                      )}
